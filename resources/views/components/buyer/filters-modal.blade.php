    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content apply-job-form">
                    ...
                    <div class="col-w-1">
                        ...
                        <ul class="list-checkbox">
                            <li class="mb-5"><a href="#"><img
                                        src="{{ asset('assets/imgs/template/icons/star.svg') }}" alt="Ecom"><img
                                        src="{{ asset('assets/imgs/template/icons/star.svg') }}" alt="Ecom"><img
                                        src="{{ asset('assets/imgs/template/icons/star.svg') }}" alt="Ecom"><img
                                        src="{{ asset('assets/imgs/template/icons/star.svg') }}" alt="Ecom"><img
                                        src="{{ asset('assets/imgs/template/icons/star.svg') }}" alt="Ecom"><span
                            ...
                            <li class="mb-5"><a href="#"><img
                                        ...
                                        src="{{ asset('assets/imgs/template/icons/star.svg') }}" alt="Ecom"><img
                                        src="{{ asset('assets/imgs/template/icons/star.svg') }}" alt="Ecom"><img
                                        src="{{ asset('assets/imgs/template/icons/star-gray.svg') }}"
                                        alt="Ecom"><span
            ...
            <div class="modal-footer justify-content-start pl-30"><a class="btn btn-buy w-auto" href="#">Apply
                    Filter</a><a id="reset-filters-btn" class="btn font-sm-bold color-gray-500" href="#">Reset
                    Filter</a></div>
        </div>
    </div>
</div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (resetButton) {
            resetButton.addEventListener('click', function(e) {
                e.preventDefault();
                const modal = document.getElementById('ModalFiltersForm');
                if (modal) {
