    ...
    <div class="dashboard-header">
        <div class="dashboard-header-content">
            ...
            <div class="wishlist-stats">
                <span class="wishlist-count">{{ $wishlistItems->count() }}
                    {{ Str::plural('item', $wishlistItems->count()) }}</span>
            </div>
        </div>
    </div>
        ...
        <div class="wishlist-container" id="wishlist-container">
            <div class="wishlist-grid" id="wishlist-grid">
                @foreach ($wishlistItems as $wishlistItem)
                    <div class="wishlist-card" data-wishlist-id="{{ $wishlistItem->id }}">
                        <div class="wishlist-card-header">
                            <div class="card-checkbox">
                                <input type="checkbox" class="wishlist-checkbox" value="{{ $wishlistItem->id }}"
                                    onchange="updateActions()">
                            </div>
                            <div class="card-actions">
                                <button type="button" class="action-btn action-btn-danger"
                                    onclick="removeFromWishlist({{ $wishlistItem->id }}, '{{ $wishlistItem->product->title ?? 'this item' }}')"
                        ...
                        <div class="product-image-container">
                            @if ($wishlistItem->product)
                                <div class="product-image">
                                    <img src="{{ $wishlistItem->product->primary_image_url ?? asset('assets/imgs/template/product-placeholder.jpg') }}"
                                        alt="{{ $wishlistItem->product->title }}"
                                        onerror="this.src='{{ asset('assets/imgs/template/product-placeholder.jpg') }}'">
                                    <div class="product-overlay">
                                        <a href="{{ route('buyer.product.show', $wishlistItem->product) }}"
                        ...
                        <div class="product-content">
                            @if ($wishlistItem->product)
                                ...
                                <div class="product-pricing">
                                    @if ($wishlistItem->product->price_discounted > 0)
                                        <div class="price-group">
                                            <span
                                                class="price-current">{{ number_format($wishlistItem->product->price_discounted, 0) }}
                                                DJF</span>
                                            <span
                                                class="price-original">{{ number_format($wishlistItem->product->price_regular, 0) }}
                                                DJF</span>
                                            <span class="price-discount">
                                                -{{ round((($wishlistItem->product->price_regular - $wishlistItem->product->price_discounted) / $wishlistItem->product->price_regular) * 100) }}%
                                            </span>
                                        </div>
                                    @else
                                        <div class="price-group">
                                            <span
                                                class="price-current">{{ number_format($wishlistItem->product->price_regular, 0) }}
                                                DJF</span>
                                        </div>
                                    @endif
                                </div>

                                @if ($wishlistItem->product->category)
                        ...
                        <div class="product-actions">
                            ...
                            @else
                                <button type="button" class="btn btn-outline-danger btn-sm"
                                    onclick="removeFromWishlist({{ $wishlistItem->id }}, 'this item')">
                                    <i class="fas fa-trash me-1"></i>
                                    Remove
                                </button>
                            @endif
