                ...
                <div class="tracking-card">
                    <div class="tracking-header">
                        <div class="tracking-order-info">
                            <div class="order-details">
                                <h3 class="order-number">Order #{{ $order->order_number ?? 'ORD-' . $order->id }}</h3>
                    ...
                    <div class="tracking-progress">
                        ...
                        <div class="progress-steps">
                            <div
                                class="progress-step {{ in_array($order->status, ['pending', 'processing', 'shipped', 'delivered']) ? 'completed' : '' }}">
                            ...
                            <div
                                class="progress-step {{ $order->status === 'processing' ? 'current' : (in_array($order->status, ['shipped', 'delivered']) ? 'completed' : '') }}">
                                <div class="step-circle">
                            ...
                            <div
                                class="progress-step {{ $order->status === 'shipped' ? 'current' : ($order->status === 'delivered' ? 'completed' : '') }}">
                                <div class="step-circle">
                        ...
                        @if ($order->statusLogs->first())
                            <div class="latest-update">
                                ...
                                <p class="update-message">{{ $order->statusLogs->first()->message ?? 'Status updated' }}
                                </p>
                                <p class="update-time">
                                    {{ $order->statusLogs->first()->created_at->format('M d, Y \a\t g:i A') }}</p>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="order-summary">
                        <div class="summary-grid">
                            <div class="summary-item">
                                ...
                                <span class="summary-value">{{ $order->orderItems->count() }} item(s)</span>
                            </div>
                            @if ($order->shipped_at)
                                <div class="summary-item">
                            ...
                            <div class="summary-item">
                                ...
                                <span class="summary-value summary-total">{{ number_format($order->final_price, 0) }}
                                    DJF</span>
                            </div>
    ...
    @else
        <div class="empty-state-card">
            <div class="empty-state">
                ...
                <a href="{{ route('buyer.dashboard.orders') }}" class="btn btn-primary">
