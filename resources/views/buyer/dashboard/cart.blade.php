        ...
        <div class="dashboard-header-content">
            ...
            <div class="cart-stats">
                @if ($cartItems && count($cartItems) > 0)
                    <span class="cart-count">{{ count($cartItems) }} {{ Str::plural('item', count($cartItems)) }}</span>
                @endif
            </div>
        </div>
    </div>
                            ...
                            <div class="cart-item" data-item-id="{{ $item['product_id'] }}">
                                ...
                                <div class="item-details">
                                    ...
                                    <div class="item-price">
                                        <span class="price-amount">{{ number_format($item['unit_price'], 0) }} DJF</span>
                                ...
                                <div class="item-total">
                                    <div class="total-amount">{{ number_format($item['total_price'], 0) }} DJF</div>
                                    <div class="total-label">Total</div>
                                </div>

                                <div class="item-actions">
                                    <button type="button" class="action-btn action-btn-danger"
                                        onclick="removeItem({{ $item['product_id'] }})" title="Remove item">
            ...
            <div class="cart-summary-section">
                <div class="cart-summary-card">
                    ...
                    <div class="summary-content">
                        <div class="summary-row">
                            ...
                            <span class="summary-value"
                                id="cart-subtotal">{{ number_format($cartTotal['subtotal'] ?? 0, 0) }} DJF</span>
                        </div>

                        <div class="summary-row">
                            <span class="summary-label">Shipping</span>
                            <span class="summary-value"
                                id="cart-shipping">{{ number_format($cartTotal['shipping'] ?? 1000, 0) }} DJF</span>
                        </div>

                        @if (($cartTotal['tax'] ?? 0) > 0)
                            <div class="summary-row">
                                <span class="summary-label">Tax</span>
                                <span class="summary-value" id="cart-tax">{{ number_format($cartTotal['tax'] ?? 0, 0) }}
                                    DJF</span>
                            </div>
                        @endif
                        ...
                        <div class="summary-row summary-total">
                            ...
                            <span class="summary-value" id="cart-total">
                                {{ number_format(($cartTotal['subtotal'] ?? 0) + ($cartTotal['shipping'] ?? 1000) + ($cartTotal['tax'] ?? 0), 0) }}
                                DJF
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="summary-actions">
                        <a id="checkout-btn" href="{{ route('checkout.index') }}" class="btn btn-primary btn-lg btn-block" onclick="handleCheckoutClick(event, this)">
                            ...
                            @foreach ($recommendedProducts->take(3) as $product)
                                <div class="recommended-item">
                                    ...
                                    <div class="recommended-details">
                                        <h5 class="recommended-title">{{ Str::limit($product->title, 25) }}</h5>
                                        <div class="recommended-price">
                                            {{ number_format($product->price_discounted > 0 ? $product->price_discounted : $product->price_regular, 0) }}
                                            DJF
                                        </div>
