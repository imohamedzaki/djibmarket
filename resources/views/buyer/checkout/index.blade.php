                                                ...
                                                <label class="address-radio-label">
                                                    ...
                                                    <div class="address-card">
                                                        ...
                                                        <div class="address-details">
                                                            ...
                                                            <div class="address-info">{{ $address->full_address }}</div>
                            ...
                            <div class="summary-content">
                                ...
                                <div class="order-totals">
                                    ...
                                    <div class="total-row">
                                        ...
                                        <span class="total-value">{{ number_format($shippingCost, 0) }} DJF</span>
                                    </div>
                                    @if ($taxAmount > 0)
                                        <div class="total-row">
                                            <span class="total-label">Tax</span>
                                            <span class="total-value">{{ number_format($taxAmount, 0) }} DJF</span>
                                        </div>
                                    @endif
        ...
        <div class="modal fade" id="newAddressModal" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="{{ route('buyer.dashboard.addresses.store') }}" method="POST" id="newAddressForm">
                        @csrf
