                ...
                <div class="col-lg-9">
                    @if (empty($cartItems))
                        <div class="cart-empty text-center py-5">
                            ...
                            <a href="{{ route('buyer.home') }}" class="btn btn-buy mt-3">Continue Shopping</a>
                        </div>
                    @else
                        <div class="box-carts">
                            ...
                            <div class="content-wishlist mb-20" id="cart-items">
                                @foreach ($cartItems as $item)
                                    <div class="item-wishlist" data-product-id="{{ $item['product_id'] }}">
                                        <div class="wishlist-cb">
                                                ...
                                                <div class="product-info">
                                                    <a href="{{ $item['product_url'] }}">
                                                        <h6 class="color-brand-3">
                                                            {{ Str::limit($item['product_title'], 60) }}</h6>
                                                    </a>
                                                    @if ($item['product']->stock_quantity <= 5)
                                                        <div class="rating">
                                                            <span class="font-xs color-gray-500">Only
                                                                {{ $item['product']->stock_quantity }} left in stock</span>
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="wishlist-price">
                                            <h4 class="color-brand-3">{{ number_format($item['unit_price'], 0) }} DJF</h4>
                                        </div>
                                            ...
                                            <div class="box-quantity">
                                                <div class="input-quantity">
                                                    ...
                                                    <span class="minus-cart"
                                                        onclick="updateQuantity({{ $item['product_id'] }}, {{ $item['quantity'] - 1 }})"></span>
                                        ...
                                        <div class="wishlist-remove">
                                            <a class="btn btn-delete" href="#"
                                                onclick="removeFromCart({{ $item['product_id'] }}); return false;"></a>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                            <div class="row mb-40">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                    <a class="btn btn-buy w-auto arrow-back mb-10"
                                        href="{{ route('buyer.home') }}">Continue shopping</a>
                                </div>
                        ...
                        <div class="summary-cart">
                            <div class="border-bottom mb-10">
                                <div class="row">
                                    ...
                                    <div class="col-6 text-end">
                                        <h4 id="cart-subtotal">{{ number_format($cartTotal, 0) }} DJF</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="border-bottom mb-10">
                            ...
                            <div class="mb-10">
                                <div class="row">
                                    ...
                                    <div class="col-6 text-end">
                                        <h4 id="cart-total">{{ number_format($cartTotal, 0) }} DJF</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="box-button">
                                <a class="btn btn-buy" href="{{ route('checkout.index') ?? '#' }}">Proceed To
                                    CheckOut</a>
                            </div>
                        </div>
                    </div>
