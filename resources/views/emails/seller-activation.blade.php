...
<head>
    ...
    <title>Confirm Your E-Mail Address - DjibMarket</title>
    <style>
        * {
...
<body>
    <div class="email-wraper">
        @if (isset($testMode) && $testMode)
            <!-- Test Mode Banner -->
            <div
                style="background: #dc3545; color: white; padding: 10px; text-align: center; font-weight: bold; font-size: 14px;">
                🧪 TEST MODE - Email Template Preview
            </div>
        @endif
        ...
        <div class="email-header" style="background: white; padding: 20px; text-align: center;">
            ...
            <p class="email-title">DjibMarket - Your Business Marketplace</p>
        </div>
        ...
        <div class="email-body">
            ...
            <div class="welcome-section">
                <h1 class="welcome-title">Welcome to DjibMarket!</h1>
                <p class="welcome-subtitle">Thank you for joining our marketplace community</p>
            </div>
            ...
            <div class="content-section">
                ...
                <p style="color: #526484; line-height: 1.6; margin-bottom: 20px;">
                    We're excited to welcome you to DjibMarket! Your seller account has been created successfully,
                    but we need to verify your email address before you can start selling.
                </p>

                <div class="highlight-box">
                    <h3 class="email-heading-s3">📧 Email Verification Required</h3>
                    <p style="margin: 0; color: #526484;">
                        Please click the button below to verify your email address and activate your seller account.
                    </p>
                </div>

                <!-- Activation Button -->
                <div style="text-align: center; margin: 30px 0;">
                    <a href="{{ $activationUrl }}" class="email-btn"
                ...
                <div class="steps-list">
                    ...
                    <ul>
                        ...
                        <li>You can log in and start setting up your store</li>
                        <li>Begin uploading products and managing your business</li>
                    </ul>
                </div>
                ...
                <a href="{{ $activationUrl }}" class="link-block"
                ...
                <div
                    ...
                    <p class="email-note" style="margin: 0; color: #856404;">
                        <strong>⚠️ Important:</strong> This verification link will expire in 24 hours. If you don't
                        verify your account within this time, you'll need to register again.
                    </p>
                </div>
