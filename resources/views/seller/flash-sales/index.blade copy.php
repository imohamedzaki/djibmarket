                                        ...
                                        <td class="nk-tb-col tb-col-md">
                                            @if ($flashSale->products && $flashSale->products->count() > 0)
                                                @foreach ($flashSale->products as $product)
                                                    <span
                                                        class="badge badge-dot bg-primary me-1">{{ $product->title }}</span>
                                                @endforeach
                                            @else
                                            ...
                                            @if ($flashSale->products && $flashSale->products->count() > 0)
                                                <div class="d-flex flex-column">
                                                    <span
                                                        ...
                                                        @else
                                                            ${{ number_format($flashSale->discount_value, 2) }}
                                                        @endif
                                                    </span>
                                        ...
                                        <td class="nk-tb-col tb-col-md">
                                            <div class="d-flex flex-column">
                                                <small><strong>From:</strong>
                                                    {{ $flashSale->start_at->format('M d, Y H:i') }}</small>
                                                <small><strong>To:</strong>
                                                    {{ $flashSale->end_at->format('M d, Y H:i') }}</small>
                                            </div>
                                        </td>
                                        <td class="nk-tb-col tb-col-md">
                                            <span
                                        ...
                                        <select
                                            ...
                                            @foreach ($products as $product)
                                                <option value="{{ $product->id }}"
                                                    ...
                                                    {{ $product->title }} ({{ $product->price_regular }})
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
