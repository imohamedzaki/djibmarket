...
<body>
    <div class="auth-container">
        ...
        <div class="auth-form-section">
            ...
            <form action="{{ route('seller.login') }}" method="post" id="loginForm" class="login-form">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="password-section">
                        ...
                        @endif
                        <a href="{{ route('seller.password.request') }}" class="forgot-link">Forgot password?</a>
                    </div>
                </div>
            ...
            <div class="signup-section">
                ...
                <a href="{{ route('seller.register') }}" class="signup-link">Create account</a>
            </div>

            <div class="signup-section" style="margin-top: 1rem; padding-top: 1rem;">
                <span class="signup-text">Account pending activation?</span>
                <a href="{{ route('seller.resend-activation') }}" class="signup-link">Resend activation email</a>
            </div>
        </div>

        <!-- Right Side - Image Section -->
        <div class="auth-image-section">
            <img src="{{ asset('assets/imgs/template/logo_only.png') }}" alt="Seller Dashboard"
