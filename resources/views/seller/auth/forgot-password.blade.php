...
<head>
    ...
    <!-- Page Title  -->
    <title>DjibMarket - Forgot Password</title>
    <!-- StyleSheets  -->
...
<body>
    <div class="auth-container">
        ...
        <div class="auth-form-section">
            ...
            <form action="{{ route('seller.password.email') }}" method="post" id="forgotForm">
                @csrf
                ...
                <div class="countdown-section" id="countdownSection">
                    <div class="countdown-text">Please wait before requesting another password reset</div>
        ...
        <div class="auth-image-section">
            <img src="{{ asset('assets/imgs/template/logo_only.png') }}" alt="Password Reset" class="background-image">
            ...
            <div class="image-content">
                <div class="seller-badge">Password Reset</div>
                <h2 class="hero-title">Secure Account Recovery</h2>
                <p class="hero-subtitle">We'll send you a secure link to reset your password and get back to managing
                    your business</p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function checkRemainingTime() {
            ...
            fetch('{{ route('seller.password.remaining-time') }}', {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    ...
                    if (!data.email_verified) {
                        ...
                        showEmailError('Your email address is not verified. Please verify your email first.');
                        submitButton.disabled = true;
                        return;
                    }
                    ...
                    if (!data.account_active) {
                        ...
                        showEmailError('Your seller account is not active. Please contact support.');
                        submitButton.disabled = true;
                        return;
                    }

                    // Email exists, is verified, and account is active - check rate limiting
        ...
        function toggleSubmitButton() {
            ...
            // If countdown is active, keep button disabled regardless of email validity
