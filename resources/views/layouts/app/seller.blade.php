<!DOCTYPE html>
<html lang="en">
@include('layouts.app.partials.seller.head')
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
    <div class="nk-app-root">
        <!-- main @s -->
        <div class="nk-main ">
            @include('layouts.app.partials.seller.sidebar')
            <!-- wrap @s -->
            <div class="nk-wrap ">
                @include('layouts.app.partials.seller.header')
                <!-- content @s -->
                ...
                <!-- content @e -->
                @include('layouts.app.partials.seller.footer')
            </div>
            <!-- wrap @e -->
        </div>
        <!-- main @e -->
