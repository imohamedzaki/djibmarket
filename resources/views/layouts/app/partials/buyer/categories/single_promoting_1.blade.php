                ...
                <div class="col-xl-6 col-lg-6">
                    <ul class="nav nav-tabs text-uppercase pr-100" role="tablist">
                        ...
                        <li><a href="#tab-3-topbrands" data-bs-toggle="tab" role="tab"
                                aria-controls="tab-3-topbrands" aria-selected="false" data-index="4">Top Brands</a></li>
                    </ul>
                    <!-- Button slider-->
                                    ...
                                    <div class="card-grid-style-3 card-ads-1">
                                        <div class="card-grid-inner text-center">
                                            <div class="info-right"><span
                                                    class="font-16 color-brand-2 text-uppercase">New Arrival</span><br>
                                                <h4 class="color-green font-32 mt-15 mb-15">Stock up your food in all
                                                    weathers</h4>
                                            </div>
                                            <div class="mt-30"><a class="btn btn-brand-2 btn-arrow-right"
                                                    href="shop-single-product-2.html">Shop Now</a></div>
                                            <div class="image-box"><a href="shop-single-product-2.html"><img
                                                        src="assets/imgs/page/homepage3/img-fridge.png"
                                                        alt="Ecom"></a></div>
                                        </div>
                                    </div>
                                    <div class="card-grid-style-3">
                                        <div class="card-grid-inner">
                                            <div class="tools"><a class="btn btn-trend btn-tooltip mb-10"
                                                    href="#" aria-label="Trend" data-bs-placement="left"></a><a
                                            ...
                                            <div class="info-right"><a class="font-xs color-gray-500"
                                                    ...
                                                    href="shop-single-product-2.html">HP 11.6&quot; Chromebook, AMD A4,
                                    ...
                                    <div class="card-grid-style-3">
                                        <div class="card-grid-inner">
                                            ...
                                            <div class="info-right"><a class="font-xs color-gray-500"
                                                    href="shop-vendor-single.html">Apple</a><br><a
                                                    class="color-brand-3 font-sm-bold"
                                                    href="shop-single-product-2.html">ASUS VivoBook 15.6&quot; 1080p PC
                                    ...
                                    <div class="card-grid-style-3">
                                        <div class="card-grid-inner">
                                            ...
                                            <div class="info-right"><a class="font-xs color-gray-500"
                                                    href="shop-vendor-single.html">Apple</a><br><a
                                                    class="color-brand-3 font-sm-bold"
                                                    href="shop-single-product-2.html">MSI Optix G272 27&quot; Full HD
                                ...
                                <div class="list-products-5">
                                    ...
                                    <div class="card-grid-style-3">
                                        <div class="card-grid-inner">
                                            ...
                                            <div class="info-right"><a class="font-xs color-gray-500"
                                                    href="shop-vendor-single.html">Apple</a><br><a
                                                    class="color-brand-3 font-sm-bold"
                                                    href="shop-single-product-2.html">2022 Apple iMac with Retina 5K
                                    ...
                                    <div class="card-grid-style-3">
                                        <div class="card-grid-inner">
                                            ...
                                            <div class="image-box"><span class="label bg-brand-2">-17%</span><a
                                                    href="shop-single-product-2.html"><img
                                                        src="assets/imgs/page/homepage1/imgsp8.png"
                                                        alt="Ecom"></a></div>
                                            <div class="info-right"><a class="font-xs color-gray-500"
                                                    href="shop-vendor-single.html">Apple</a><br><a
                                                    class="color-brand-3 font-sm-bold"
