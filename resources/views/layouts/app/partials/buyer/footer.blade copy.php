            ...
            <div class="row">
                <div class="col-lg-3 width-25 mb-30">
                    ...
                    <div class="font-md mb-20 color-gray-900"><strong class="font-md-bold">Address:</strong> 502 New
                        Design Str, Melbourne, San Francisco, CA 94110, United States</div>
                    ...
                    <div class="font-md mb-20 color-gray-900"><strong class="font-md-bold">E-mail:</strong>
                        contact@djibmarket-market.com</div>
                ...
                <div class="col-lg-3 width-23">
                    ...
                    <div>
                        ...
                        <div class="mt-20"><a class="mr-10" href="#"><img
                                    src="{{ asset('assets/imgs/template/appstore.png') }}" alt="DjibMarket"></a><a
                                href="#"><img src="{{ asset('assets/imgs/template/google-play.png') }}"
                                    alt="DjibMarket"></a></div>
                        <p class="font-md color-gray-900 mt-20 mb-10">Secured Payment Gateways</p><img
                            src="{{ asset('assets/imgs/template/payment-method.png') }}" alt="DjibMarket">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="footer-bottom-1">
            <div class="container">
                <div class="footer-2-top mb-20">
                    <a href="index.html" style="width:7%;">
                        <img alt="DjibMarket" src="{{ asset('assets/imgs/template/logo_only.png') }}"></a><a
                        class="font-xs color-gray-1000" href="#">djibMarket.com</a><a class="font-xs color-gray-1000"
                        href="#">DjibMarket
                        Partners</a><a class="font-xs color-gray-1000" href="#">DjibMarket Bussiness</a><a
                        class="font-xs color-gray-1000" href="#">DjibMarket Factory</a>
                </div>
                <div class="footer-2-bottom">
                    ...
                    <div class="tags-footer"><a href="shop-fullwidth.html">Cell Phones</a><a
                            ...
                            href="shop-grid.html">Mackbook Pro M1</a><a href="shop-grid.html">HD Videos Player</a>
                    </div>
                </div>
                <div class="footer-2-bottom">
                    <div class="head-left-footer">
            ...
            <div class="footer-bottom mt-20">
                <div class="row">
                    <div class="col-lg-6 col-md-12 text-center text-lg-start"><span
                            class="color-gray-900 font-sm">Copyright &copy; 2024 DjibMarket. All rights
                            reserved.</span></div>
