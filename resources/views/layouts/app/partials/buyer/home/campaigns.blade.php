                                ...
                                <div class="swiper-slide">
                                    <div class="card-product-small">
                                        ...
                                        <div class="card-info">
                                            ...
                                            @if (isset($product->campaign_promotion_title))
                                                <div style="font-size: 12px; color: #007bff; margin-top: 5px;">
                                                    {{ $product->campaign_promotion_title }}
                                                </div>
                                            @endif
                                        </div>
                                    </div>
