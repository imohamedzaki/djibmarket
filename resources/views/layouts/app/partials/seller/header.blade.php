    ...
    <div class="container-fluid">
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-brand d-xl-none">
                <a href="{{ route('seller.dashboard') }}" class="logo-link">
            ...
            <div class="nk-header-tools">
                <ul class="nk-quick-nav">
                    @include('layouts.app.includes.seller.dropdownLanguage')
                    @include('layouts.app.includes.seller.dropdownChats')
                    @include('layouts.app.includes.seller.dropdownNotification')
                    @include('layouts.app.includes.seller.dropdownUser')
                </ul>
            </div>
        </div><!-- .nk-header-wrap -->
    </div><!-- .container-fliud -->
