                ...
                <div class="box-swiper">
                    <div class="swiper-container swiper-group-10">
                        <div class="swiper-wrapper">
                            ...
                            ?>
                            <?php if($activeAdsCompanies->count() > 0): ?>
                                <?php $__currentLoopData = $activeAdsCompanies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adsCompany): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="swiper-slide">
                                        <a href="<?php echo e($adsCompany->link ?: '#'); ?>"
                                            <?php echo e($adsCompany->link ? 'target="_blank"' : ''); ?>>
                                            <?php if($adsCompany->logo): ?>
                                                <img src="<?php echo e(asset('storage/' . $adsCompany->logo)); ?>"
                                                    alt="<?php echo e($adsCompany->name); ?>">
                                            <?php else: ?>
                                                <div class="placeholder-logo"
                                                    ...
                                                    <span
                                                        style="font-size: 12px; color: #6c757d;"><?php echo e($adsCompany->name); ?></span>
                                                </div>
                                            <?php endif; ?>
                                        </a>
                                    </div>
...
<?php /**PATH C:\laragon\www\djibmarket\resources\views/layouts/app/partials/buyer/ads/ads_companies.blade.php ENDPATH**/ ?>