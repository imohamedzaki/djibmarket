        ...
        <div class="container">
            <div class="row ads-space-2-container">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
                    <?php if($powerBankAds->count() > 0): ?>
                        <?php
                            $ad = $powerBankAds->first();
                            $colors = json_decode($ad->custom_colors, true);
                        ?>
                        <div class="<?php echo e($colors['background_class'] ?? 'bg-4'); ?> block-charge ads-space-2-item">
                            <span class="color-brand-3 font-sm-lh32"><?php echo e($colors['label_text'] ?? 'Power Bank'); ?></span>
                            <h3 class="font-xl mb-10"><?php echo e($ad->headline); ?></h3>
                            <p class="font-base color-brand-3 mb-20"><?php echo nl2br($ad->sub_headline); ?></p>
                            <a class="btn btn-brand-2 btn-arrow-right" href="<?php echo e($ad->call_to_action_url ?? '#'); ?>"
                                onclick="trackAdClick(<?php echo e($ad->id); ?>)">
                                <?php echo e($ad->call_to_action_text); ?>

                            </a>
                            <img src="<?php echo e(asset($ad->ad_image)); ?>" alt="<?php echo e($ad->title); ?>" style="display: none;"
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
                    <?php if($gameControllerAds->count() > 0): ?>
                        <?php
                            $ad = $gameControllerAds->first();
                            $colors = json_decode($ad->custom_colors, true);
                        ?>
                        <div class="<?php echo e($colors['background_class'] ?? 'bg-6'); ?> block-player ads-space-2-item">
                            <h3 class="font-33 mb-20"><?php echo e($ad->headline); ?></h3>
                            <div class="mb-30"><strong class="font-16"><?php echo e($ad->sub_headline); ?></strong></div>
                            <a class="btn btn-brand-3 btn-arrow-right" href="<?php echo e($ad->call_to_action_url ?? '#'); ?>"
                                onclick="trackAdClick(<?php echo e($ad->id); ?>)">
                                <?php echo e($ad->call_to_action_text); ?>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
                    <?php if($iphoneAds->count() > 0): ?>
                        <?php
                            $ad = $iphoneAds->first();
                            $colors = json_decode($ad->custom_colors, true);
                        ?>
                        <div class="<?php echo e($colors['background_class'] ?? 'bg-5'); ?> block-iphone ads-space-2-item">
                            <span
                                class="color-brand-3 font-sm-lh32"><?php echo e($colors['label_text'] ?? 'Starting from $899'); ?></span>
                            <h3 class="font-xl mb-10"><?php echo e($ad->headline); ?></h3>
                            <p class="font-base color-brand-3 mb-10"><?php echo e($ad->sub_headline); ?></p>
...
<?php /**PATH C:\laragon\www\djibmarket\resources\views/layouts/app/partials/buyer/ads/ads_space_2.blade.php ENDPATH**/ ?>