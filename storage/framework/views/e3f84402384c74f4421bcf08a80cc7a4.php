        ...
        <div class="dropdown-body">
            <ul class="chat-list">
                ...
                <li class="chat-item">
                    <a class="chat-link" href="html/lms/message.html">
                        <div class="chat-media user-avatar">
                            <img src="<?php echo e(asset('images')); ?>/avatar/b-sm.jpg" alt="">
                        </div>
                        <div class="chat-info">
                            <div class="chat-from">
                    ...
                    <a class="chat-link" href="html/lms/message.html">
                        <div class="chat-media user-avatar user-avatar-multiple">
                            <div class="user-avatar">
                                <img src="<?php echo e(asset('images')); ?>/avatar/c-sm.jpg" alt="">
                            </div>
                            <div class="user-avatar">
                                <span>AB</span>
                            </div>
                ...
                <li class="chat-item">
                    <a class="chat-link" href="html/lms/message.html">
                        <div class="chat-media user-avatar">
                            <img src="<?php echo e(asset('images')); ?>/avatar/a-sm.jpg" alt="">
                            <span class="status dot dot-lg dot-success"></span>
                        </div>
                        <div class="chat-info">
                            <div class="chat-from">
...
<?php /**PATH C:\laragon\www\djibmarket\resources\views/layouts/app/includes/admin/dropdownChats.blade.php ENDPATH**/ ?>