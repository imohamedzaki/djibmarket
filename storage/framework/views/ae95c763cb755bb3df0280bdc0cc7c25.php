<?php $__env->startSection('dashboard-content'); ?>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <div class="address-card <?php echo e($address->is_default ? 'address-default' : ''); ?>">
            <div class="address-header">
                <div class="address-title-section">
                    <h3 class="address-title"><?php echo e($address->title); ?></h3>
                    <?php if($address->is_default): ?>
                        <span class="default-badge">Default</span>
                    <?php endif; ?>
                </div>
                <div class="address-actions">
                    <button type="button" class="action-btn action-btn-primary" onclick="editAddress(<?php echo e($address->id); ?>)"
                        data-bs-toggle="modal" data-bs-target="#editAddressModal" title="Edit address">
                        <i class="fas fa-edit"></i>
                    </button>
                    <?php if(!$address->is_default): ?>
                        <form action="<?php echo e(route('buyer.dashboard.addresses.delete', $address)); ?>" method="POST"
                            class="delete-form">
                            <?php echo csrf_field(); ?>
            ...
            <div class="address-content">
                <div class="contact-info">
                    <h4 class="contact-name"><?php echo e($address->full_name); ?></h4>
                ...
                <div class="address-details">
                    <div class="address-text"><?php echo e($address->full_address); ?></div>
                    <?php if($address->notes): ?>
                        <div class="address-notes">
                            <i class="fas fa-sticky-note me-1"></i>
                            <?php echo e($address->notes); ?>
                ...
                <?php if($address->hasCoordinates()): ?>
                    <div class="coordinates-section">
                        <div class="coordinates-info">
                            ...
                            <span class="coordinates-text"><?php echo e($address->coordinates); ?></span>
                        </div>
                        <div class="coordinates-actions">
                            <button type="button" class="coord-btn"
                                onclick="copyToClipboard('<?php echo e($address->coordinates); ?>')" title="Copy coordinates">
                                <i class="fas fa-copy"></i>
                                Copy
                            </button>
                            <a href="<?php echo e($address->google_maps_url); ?>" target="_blank" class="coord-btn"
                                title="Open in Google Maps">
                                <i class="fas fa-external-link-alt"></i>
                                Maps
                            </a>
                            <a href="<?php echo e($address->whatsapp_location_url); ?>" target="_blank" class="coord-btn"
    ...
    <script>
        ...
        function editAddress(addressId) {
            ...
            // Update form action
            const updateUrl = "<?php echo e(route('buyer.dashboard.addresses.update', ':id')); ?>".replace(':id', addressId);
...
<?php echo $__env->make('buyer.dashboard.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\djibmarket\resources\views/buyer/dashboard/addresses.blade.php ENDPATH**/ ?>