                ...
                <div class="wishlist-card">
                    ...
                    <div class="product-info">
                        <?php if($wishlistItem->product): ?>
                            ...
                            <p class="product-price">
                                <?php echo e(number_format($wishlistItem->product->price_discounted > 0 ? $wishlistItem->product->price_discounted : $wishlistItem->product->price_regular, 2)); ?>

                                DJF</p>
                            <?php if($wishlistItem->product->price_discounted > 0): ?>
                                <p class="product-discount">
                                    <span
                                        class="original-price"><?php echo e(number_format($wishlistItem->product->price_regular, 2)); ?>

                                        DJF</span>
                                    <span
                                        class="discount-price"><?php echo e(number_format($wishlistItem->product->price_discounted, 2)); ?>

                                        DJF</span>
                                </p>
                            <?php endif; ?>
                            <p class="added-date">Added <?php echo e($wishlistItem->created_at->diffForHumans()); ?></p>
                        <?php else: ?>
                    ...
                    <div class="product-actions">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-danger remove-wishlist-btn"
                            data-wishlist-id="<?php echo e($wishlistItem->id); ?>"
                            data-product-title="<?php echo e($wishlistItem->product->title ?? 'this item'); ?>">
