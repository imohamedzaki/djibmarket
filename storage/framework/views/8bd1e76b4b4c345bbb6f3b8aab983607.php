...
<?php if($kitchenAppliancesAds->count() > 0): ?>
    <?php
    ...
    <section class="section-box mt-30">
        <div class="container">
            <div class="<?php echo e($colors['background_class'] ?? 'banner-ads'); ?> text-center ads-space-5-item"
                style="
                    <?php if(isset($colors['background_color'])): ?> background-color: <?php echo e($colors['background_color']); ?>; <?php endif; ?>
                    <?php if(isset($colors['background_image_main'])): ?> background-image: url('<?php echo e(asset($colors['background_image_main'])); ?>'); background-repeat: no-repeat; background-position: 0px 0px; <?php endif; ?>
                "
                data-bg-before="<?php echo e($colors['background_image_before'] ?? ''); ?>"
                data-bg-after="<?php echo e($colors['background_image_after'] ?? ''); ?>">
                <h2
                    class="<?php echo e($colors['title_color'] ?? 'color-brand-2'); ?> <?php echo e($colors['title_size'] ?? 'font-46'); ?> mb-5">
                    <?php echo e($ad->headline); ?></h2>
                <p class="font-bold font-17 <?php echo e($colors['text_color'] ?? 'color-white'); ?>"><?php echo nl2br($ad->sub_headline); ?></p>
                <div class="mt-20">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (adItem) {
            ...
            if (bgBeforeUrl) {
                bgImages.push(`url('<?php echo e(asset('')); ?>${bgBeforeUrl}')`);
            ...
            if (bgAfterUrl) {
                bgImages.push(`url('<?php echo e(asset('')); ?>${bgAfterUrl}')`);
...
<?php /**PATH C:\laragon\www\djibmarket\resources\views/layouts/app/partials/buyer/ads/ads_space_5.blade.php ENDPATH**/ ?>