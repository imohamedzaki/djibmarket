...
<?php $__env->startSection('title', 'Contact Us - DjibMarket'); ?>
                        ...
                        <div class="col-lg-7">
                            <div class="contact-form-section">
                                ...
                                <div class="contact-form">
                                    ...
                                    <form action="<?php echo e(route('buyer.contact.submit')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <div class="row">
                                            <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>" name="message"
                                                placeholder="Tell us how we can help you..." rows="5" required><?php echo e(old('message')); ?></textarea>
        ...
        <section class="features-section">
            <div class="container">
                <div class="features-grid">
                    ...
                    <div class="feature-item">
                        <div class="feature-icon">
                            <img src="<?php echo e(asset('assets/imgs/template/voucher.svg')); ?>" alt="Gift Vouchers">
                        </div>
                        <div class="feature-content">
                            <h4>Gift Vouchers</h4>
...
<?php echo $__env->make('layouts.app.buyer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\djibmarket\resources\views/buyer/contact.blade.php ENDPATH**/ ?>