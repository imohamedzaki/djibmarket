...
<?php endif; ?>
            ...
            <form action="<?php echo e(route('admin.login')); ?>" method="post" id="loginForm" class="login-form">
                <?php echo csrf_field(); ?>
        ...
        <div class="auth-image-section">
            <img src="<?php echo e(asset('assets/imgs/template/logo_only.png')); ?>" alt="Admin Dashboard"
