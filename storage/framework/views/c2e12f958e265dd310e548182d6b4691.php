<div class="topbar">
    <div class="container-topbar">
        <div class="menu-topbar-left">
            <ul class="nav-small">
                <li><a class="font-xs" href="<?php echo e(route('buyer.about')); ?>">About Us</a></li>
                <li><a class="font-xs" href="<?php echo e(route('buyer.join')); ?>">Join US</a></li>
                <li><a class="font-xs" href="<?php echo e(route('seller.register')); ?>">Become a seller</a></li>
                <li><a class="font-xs" href="<?php echo e(route('vendors.index')); ?>">List of vendors</a></li>
                <li><a class="font-xs" href="<?php echo e(route('buyer.contact')); ?>">Contact Us</a></li>
            </ul>
        </div>
                ...
                <button class="btn dropdown-toggle" id="dropdownPage" type="button" data-bs-toggle="dropdown"
                    aria-expanded="true" data-bs-display="static"><span
                        class="dropdown-right font-xs color-brand-3"><img
                            src="<?php echo e(asset('assets/imgs/template/en.svg')); ?>" alt="Ecom"> English</span></button>
                <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="dropdownPage" data-bs-popper="static">
                    <li><a class="dropdown-item" href="#"><img
                                src="<?php echo e(asset('assets/imgs/template/flag-en.svg')); ?>" alt="English"> English</a></li>
                    <li><a class="dropdown-item" href="#"><img
                                src="<?php echo e(asset('assets/imgs/template/flag-fr.svg')); ?>" alt="Français"> Français</a></li>
                    <li><a class="dropdown-item" href="#"><img
                                src="<?php echo e(asset('assets/imgs/template/flag-ar.svg')); ?>" style="width:18.3px;"
...
<?php /**PATH C:\laragon\www\djibmarket\resources\views/layouts/app/partials/buyer/topbar.blade.php ENDPATH**/ ?>