...
<body>
    <div class="auth-container">
        ...
        <div class="auth-form-section">
            <a href="<?php echo e(route('buyer.home')); ?>" class="back-link">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" id="registerForm" class="register-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input <?php echo e($errors->get('name') ? 'error' : ''); ?>" id="name"
                        name="name" placeholder="Enter your full name" value="<?php echo e(old('name')); ?>" required
                        autofocus>
                    <?php if($errors->get('name')): ?>
                        <div class="error-message"><?php echo $errors->get('name')[0]; ?></div>
                    <?php endif; ?>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password"
                            class="form-input <?php echo e($errors->get('password_confirmation') ? 'error' : ''); ?>"
                        ...
                        <?php if($errors->get('password_confirmation')): ?>
                            <div class="error-message"><?php echo e($errors->get('password_confirmation')[0]); ?></div>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="auth-image-section">
            <img src="<?php echo e(asset('assets/imgs/template/logo_only.png')); ?>" alt="Join DjibMarket"
