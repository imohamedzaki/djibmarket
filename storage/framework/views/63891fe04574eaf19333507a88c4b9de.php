...
<?php endif; ?>
            ...
            <?php if(session('success')): ?>
                <div class="info-message mb-4"><?php echo e(session('success')); ?></div>
            <?php endif; ?>

            
            <?php if(session('error')): ?>
                <div class="error-message mb-4"><?php echo e(session('error')); ?></div>
            <?php endif; ?>

            
            <?php if(session('info')): ?>
                <div class="info-message mb-4"><?php echo e(session('info')); ?></div>
            <?php endif; ?>
        ...
        <div class="auth-image-section">
            <img src="<?php echo e(asset('assets/imgs/template/logo_only.png')); ?>" alt="Buyer Dashboard"
...
</html><?php /**PATH C:\laragon\www\djibmarket\resources\views/buyer/auth/login.blade.php ENDPATH**/ ?>