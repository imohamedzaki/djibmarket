<?php if(isset($categoryData) && $categoryData): ?>
                ...
                <div class="d-flex">
                    <div class="box-category-left">
                        <div class="box-menu-category bg-white">
                            <h5 class="title-border-bottom mb-20"><?php echo e($categoryData['parentCategory']->name); ?></h5>
                            <ul class="list-nav-arrow" id="category-list">
                                <?php $__currentLoopData = $categoryData['subcategories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <a href="#" class="category-link <?php echo e($index === 0 ? 'active' : ''); ?>"
                    ...
                    <div class="box-category-right">
                        <div class="row" id="products-container">
                            <?php $__currentLoopData = $categoryData['subcategories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryIndex => $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="category-products" data-category-index="<?php echo e($categoryIndex); ?>"
                                                        ...
                                                        <div class="card-grid-inner">
                                                            ...
                                                            <div class="image-box">
                                                                <?php if(
                                                                    ...
                                                                    ?>
                                                                    <span
                                                                        class="label bg-brand-2">-<?php echo e($discountPercentage); ?>%</span>
                                                                <?php endif; ?>
                                                                <a
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\djibmarket\resources\views/layouts/app/partials/buyer/categories/products_categories_1.blade.php ENDPATH**/ ?>