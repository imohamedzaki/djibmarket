            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="box-button-slider-2">
                        <div class="swiper-button-prev swiper-button-prev-style-top swiper-button-prev-bestselling">
                        </div>
                        <div class="swiper-button-next swiper-button-next-style-top swiper-button-next-bestselling">
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="card-product-small">
                                        <div class="card-image">
                                            <a href="#"
                                                ...
                                                <img src="<?php echo e($product->featured_image_url ?? asset('assets/imgs/page/homepage9/sp4.png')); ?>"
                                        ...
                                        <div class="card-info">
                                            ...
                                            <?php if(isset($product->total_sold) && $product->total_sold > 0): ?>
                                                <div style="font-size: 12px; color: #28a745; margin-top: 5px;">
                                                    <?php echo e($product->total_sold); ?> sold
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                ...
                <div class="no-products-container">
                    <div class="no-products-icon" style="margin-bottom: 20px;">
                        <svg width="80" height="80" viewBox="0 0 24 24" fill="none"
                            ...
                            <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" stroke="#6c757d" stroke-width="1.5"
...
<?php /**PATH C:\laragon\www\djibmarket\resources\views/layouts/app/partials/buyer/home/best_selling.blade.php ENDPATH**/ ?>