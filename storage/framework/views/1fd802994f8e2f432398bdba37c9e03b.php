...
<div class="dropdown-cart" id="cart-dropdown">
    ...
    <?php echo $__env->make('layouts.app.partials.buyer.cart-content', compact('cartItems', 'cartTotal', 'cartCount'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
...
<script>
    ...
    function updateCartUI() {
        ...
        fetch('<?php echo e(route('cart.html')); ?>', {
                method: 'GET',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                }
...
<?php /**PATH C:\laragon\www\djibmarket\resources\views/layouts/app/partials/buyer/cart.blade.php ENDPATH**/ ?>