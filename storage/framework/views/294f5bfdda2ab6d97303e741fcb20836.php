    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 mb-20">
                <?php if($latestBooksAds->count() > 0): ?>
                    <?php
                        $ad = $latestBooksAds->first();
                        $colors = json_decode($ad->custom_colors, true);
                    ?>
                    <div class="block-sale-2 <?php echo e($colors['background_class'] ?? 'circle-1'); ?> ads-space-3-item"
                        style="<?php if(isset($colors['background_color'])): ?> background-color: <?php echo e($colors['background_color']); ?>; <?php endif; ?> <?php if(isset($colors['background_image'])): ?> background-image: url(<?php echo e(asset($colors['background_image'])); ?>); background-repeat: no-repeat; background-position: bottom right; <?php endif; ?>">
                        <div class="row height-100">
                            <div class="col-lg-7 col-md-7 col-sm-7 col-12 height-100 align-items-center d-flex">
                                <div class="box-sale">
                                    <span
                                        class="font-sm color-brand-3"><?php echo e($colors['label_text'] ?? 'Latest Books'); ?></span>
                                    <h4 class="mt-5 mb-10"><?php echo e($ad->headline); ?></h4>
                                    <p class="color-brand-3 font-sm mb-5"><?php echo nl2br($ad->sub_headline); ?></p>
                                    <a class="btn btn-arrow" href="<?php echo e($ad->call_to_action_url ?? '#'); ?>"
            ...
            <div class="col-lg-4 mb-20">
                <?php if($bestCollectionAds->count() > 0): ?>
                    <?php
                        $ad = $bestCollectionAds->first();
                        $colors = json_decode($ad->custom_colors, true);
                    ?>
                    <div class="block-sale-2 <?php echo e($colors['background_class'] ?? 'bg-4 circle-2'); ?> ads-space-3-item"
                        style="<?php if(isset($colors['background_color'])): ?> background-color: <?php echo e($colors['background_color']); ?>; <?php endif; ?> <?php if(isset($colors['background_image'])): ?> background-image: url(<?php echo e(asset($colors['background_image'])); ?>); background-repeat: no-repeat; background-position: bottom right; <?php endif; ?>">
                        <div class="row height-100">
                            <div class="col-lg-6 col-md-7 col-sm-7 col-12 height-100 align-items-center d-flex">
                                <div class="box-sale">
                                    <span
                                        class="font-sm color-brand-3"><?php echo e($colors['label_text'] ?? 'Best collection'); ?></span>
                                    <h4 class="mt-5 mb-10"><?php echo e($ad->headline); ?></h4>
                                    <p class="color-brand-3 font-sm mb-5"><?php echo e($ad->sub_headline); ?></p>
                                    <a class="btn btn-arrow" href="<?php echo e($ad->call_to_action_url ?? '#'); ?>"
                                        onclick="trackAdClick(<?php echo e($ad->id); ?>)">
                                        <?php echo e($ad->call_to_action_text); ?>
            ...
            <div class="col-lg-4 mb-20">
                <?php if($professionalBooksAds->count() > 0): ?>
                    <?php
                        $ad = $professionalBooksAds->first();
                        $colors = json_decode($ad->custom_colors, true);
                    ?>
                    <div class="block-sale-2 <?php echo e($colors['background_class'] ?? 'bg-10 circle-3'); ?> ads-space-3-item"
                        style="<?php if(isset($colors['background_color'])): ?> background-color: <?php echo e($colors['background_color']); ?>; <?php endif; ?> <?php if(isset($colors['background_image'])): ?> background-image: url(<?php echo e(asset($colors['background_image'])); ?>); background-repeat: no-repeat; background-position: bottom right; <?php endif; ?>">
                        <div class="row height-100">
                            <div class="col-lg-6 col-md-7 col-sm-7 col-12 height-100 align-items-center d-flex">
                                <div class="box-sale">
                                    <span
                                        class="font-sm color-brand-3"><?php echo e($colors['label_text'] ?? 'Off the month'); ?></span>
                                    <h4 class="mt-5 mb-10"><?php echo e($ad->headline); ?></h4>
                                    <p class="color-brand-3 font-sm mb-5"><?php echo e($ad->sub_headline); ?></p>
                                    <a class="btn btn-arrow" href="<?php echo e($ad->call_to_action_url ?? '#'); ?>"
                                        onclick="trackAdClick(<?php echo e($ad->id); ?>)">
...
<?php /**PATH C:\laragon\www\djibmarket\resources\views/layouts/app/partials/buyer/ads/ads_space_3.blade.php ENDPATH**/ ?>